...
<body>
<div style="text-align:center;margin-bottom:8px"><img src="{{ public_path('images/logo.jpg') }}" style="width:40px;height:40px;object-fit:contain"></div><h2>নবদিগন্ত সমবায় সমিতি — Annual Summary {{ $year }}</h2>
