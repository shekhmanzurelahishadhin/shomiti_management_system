...
return [
    ...
    'batching'    => ['database' => env('DB_BATCHING_CONNECTION', env('DB_CONNECTION', 'sqlite')), 'table' => env('DB_BATCHING_TABLE', 'job_batches')],
    'failed'      => ['driver' => env('QUEUE_FAILED_DRIVER', 'database-uuids'), 'database' => env('DB_FAILED_CONNECTION', env('DB_CONNECTION', 'sqlite')), 'table' => env('DB_FAILED_TABLE', 'failed_jobs')],
];
